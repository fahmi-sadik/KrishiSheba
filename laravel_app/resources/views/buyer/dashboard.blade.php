    ...
    <main class="main-content">
        <header class="topbar">
            <form action="{{ route('buyer.dashboard') }}" method="GET" class="search-bar">
                <button type="submit" style="background: none; border: none; cursor: pointer; padding: 0; display: flex; align-items: center; margin-right: 8px;">
                    <i class="fa-solid fa-magnifying-glass" style="color: var(--text-muted);"></i>
                </button>
                <input type="text" name="search" value="{{ $query ?? '' }}" placeholder="সবজি, ফল বা বীজ খুঁজুন..." style="border:none; outline:none; background:transparent; flex:1;">
            </form>
        ...
        <div class="dashboard-content">
            ...
            @if(isset($query) && $query)
                <h2 id="products" class="page-title" style="margin-bottom: 20px;">"{{ $query }}" এর জন্য ফলাফল ({{ $products->count() }}টি পাওয়া গেছে)</h2>
            @else
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-bottom">
                            <div class="product-price">৳ {{ enToBn((float) $product->price) }} <span>/ কেজি</span></div>
                ...
                @empty
                    <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: var(--text-muted);">
                        ...
                        <h3>কোন পণ্য পাওয়া যায়নি</h3>
                        <p>আপনার অনুসন্ধানের সাথে মিলে এমন কোন পণ্য আমরা খুঁজে পাইনি।</p>
                        <a href="{{ route('buyer.dashboard') }}" class="btn btn-outline" style="margin-top: 15px; display: inline-block;">সব পণ্য দেখুন</a>
                    </div>
                @endforelse
            </div>
        </div>
