...
<body class="dashboard-body">
    ...
    <main class="main-content">
        ...
        <div class="dashboard-content">
            ...
            <!-- Welcome Banner -->
            <div style="background: linear-gradient(135deg, #1e3c72, #2a5298); border-radius: 15px; padding: 35px 40px; color: white; margin-bottom: 35px; box-shadow: 0 10px 25px rgba(30, 60, 114, 0.2); display: flex; align-items: center; justify-content: space-between; overflow: hidden; position: relative;">
                <div style="position: relative; z-index: 2; max-width: 70%;">
                    <h2 style="margin-bottom: 10px; font-size: 2.2rem; font-weight: 700;">স্বাগতম, {{ Auth::user()->name }}! 👋</h2>
                    <p style="opacity: 0.9; font-size: 1.1rem; line-height: 1.6; margin-bottom: 0;">কৃষিসেবা অ্যাডমিন প্যানেলে আপনাকে স্বাগতম। আজকের কার্যক্রম, ব্যবহারকারী এবং প্ল্যাটফর্মের সার্বিক অবস্থা একনজরে দেখে নিন।</p>
                </div>
                <i class="fa-solid fa-chart-pie" style="font-size: 160px; position: absolute; right: 0; top: 10px; opacity: 0.1; transform: rotate(-15deg);"></i>
            </div>
            
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 class="page-title" style="margin-bottom: 0;">প্ল্যাটফর্ম ওভারভিউ</h2>
                <span style="background: #e3f2fd; color: #1565c0; padding: 5px 15px; border-radius: 20px; font-weight: 600; font-size: 0.9rem;"><i class="fa-solid fa-calendar-day"></i> {{ \Carbon\Carbon::now()->format('d M, Y') }}</span>
            </div>
